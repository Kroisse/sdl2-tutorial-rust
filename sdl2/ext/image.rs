use super::super::render::{Renderer, Texture};
use super::super::get_error;
...
mod ll {
    ...
    pub use super::super::super::ll::{SDL_version, SDL_RWops,
    ...
    #[link(name = "SDL2_image", kind = "framework")]
    extern "C" {
...
pub fn load_texture<'a>(renderer: &'a Renderer, path: &Path) -> Result<Texture<'a>, StrBuf> {
    unsafe {
        let p = path.with_c_str(|s| {
